 ...
 *
 */
public class LineChartCustomDrawSupplier extends ApplicationFrame {
	 ...
	 */
	public LineChartCustomDrawSupplier(final String title) {
		super(title);
...
//        renderer.setDrawShapes(true);
	...
	public static void main(final String[] args) {
		...
		final LineChartCustomDrawSupplier demo = new LineChartCustomDrawSupplier("Line Chart Demo 5");
		demo.pack();
