...
public class TimeSeriesBar2 extends ApplicationFrame {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	public TimeSeriesBar2(final String title) {
		super(title);
	...
	public static void main(final String[] args) {
		final TimeSeriesBar2 demo = new TimeSeriesBar2("Time Series Bar Demo 2");
		demo.pack();
